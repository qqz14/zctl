...
import (
	...
	"github.com/qqz14/zctl/api/parser/g4/ast"
	"github.com/qqz14/zctl/api/parser/g4/gen/api"
	"github.com/qqz14/zctl/api/spec"
	"github.com/qqz14/zctl/pkg/env"
	apiParser "github.com/qqz14/zctl/pkg/parser/api/parser"
)
...
// Deprecated: use tools/zctl/pkg/parser/api/parser/parser.go:18 instead,
