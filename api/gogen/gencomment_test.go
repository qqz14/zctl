...
func TestGenerationComments(t *testing.T) {
	...
	tempDir, err := os.MkdirTemp("", "zctl_test_")
...
func TestRoutesGenerationComment(t *testing.T) {
	// Create a temporary directory for our test
	tempDir, err := os.MkdirTemp("", "zctl_routes_test_")
	require.NoError(t, err)
	defer os.RemoveAll(tempDir)
...
func TestCommentsFollowGoStandards(t *testing.T) {
	...
	doNotEditComment := "// Code generated by zctl. DO NOT EDIT."
	safeToEditComment := "// Code scaffolded by zctl. Safe to edit."
	...
	assert.Contains(t, doNotEditComment, "zctl",
		"DO NOT EDIT comment should mention zctl")
	assert.Contains(t, safeToEditComment, "zctl",
		"Safe to edit comment should mention zctl")
