...
import (
	...
	"github.com/qqz14/zctl/pkg/downloader"
	"github.com/qqz14/zctl/pkg/zctl"
	"github.com/qqz14/zctl/rpc/execx"
	"github.com/qqz14/zctl/util/env"
	"github.com/qqz14/zctl/util/zipx"
...
func Install(cacheDir string) (string, error) {
	return zctl.Install(cacheDir, Name, func(dest string) (string, error) {
		goos := runtime.GOOS
