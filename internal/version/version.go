...
// BuildVersion is the version of zctl.
const BuildVersion = "1.11.1-openapi.1"
...
// IsVersionGreaterThan compares whether the current zctl version
...
func IsVersionGreaterThan(version, target string) bool {
	...
	if versionNumber > targetVersionNumber {
		...
		// unchecked case, in normal, the zctl version does not contain suffix in release.
