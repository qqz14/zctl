...
type ZRpcContext struct {
	...
	ProtoPaths []string
	// I18n indicates whether to enable i18n support
	I18n bool
...
func (g *Generator) Generate(zctx *ZRpcContext) error {
	...
	if err = g.GenScaffold(abs, projectCtx, zctx); err != nil {
		return err
	}

	// Generate module placeholder files (model/consts/errcode) for each desc subdirectory
	if err = g.GenModuleFiles(abs); err != nil {
		return err
	}
