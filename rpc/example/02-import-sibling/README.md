...
- Only the proto file containing `service` definitions needs to be passed to `zctl rpc protoc`.
- The imported proto is automatically compiled by protoc and resolved by zctl.
