...
This directory contains complete examples for all `zctl rpc` code generation scenarios.
...
- [zctl](https://github.com/zeromicro/go-zero/tree/master/tools/zctl)
