...
func migrateBefore1_3_4(dir, style string) error {
	...
	fmt.Println(`It seems like that your zctl has just been upgraded to version 1.3.4 or later, which refactored the code of the model module. The original XXXmodel.go has been split into XXXmodel_gen.go (read-only) and XXXmodel.go. You just need to follow these steps to complete the migration:
...
3. populate XXXmodel.go with the code that is not generated by zctl according to the comments in XXXmodel_gen.go`)
